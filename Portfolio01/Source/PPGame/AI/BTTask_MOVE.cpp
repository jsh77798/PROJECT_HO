...
#include <AI/Portfolio_AIController.h>
#include <AI/Portfolio_MonsterEnums.h>
...
void UBTTask_MOVE::TickTask(UBehaviorTreeComponent& OwnerComp, uint8* NodeMemory, float DelataSeconds)
{
...

	{
		...
		FVector OriginPos = GetBlackboardComponent(OwnerComp)->GetValueAsVector(TEXT("PrePos"));
