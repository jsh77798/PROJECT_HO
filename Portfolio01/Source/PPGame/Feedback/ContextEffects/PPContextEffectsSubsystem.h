...
class PPGAME_API UPPContextEffectsSettings : public UDeveloperSettings
{
	GENERATED_BODY()
 ...
 */
UCLASS()
class PPGAME_API UPPContextEffectsSet : public UObject
{
	GENERATED_BODY()
 ...
 */
UCLASS()
class PPGAME_API UPPContextEffectsSubsystem : public UWorldSubsystem
{
	GENERATED_BODY()
