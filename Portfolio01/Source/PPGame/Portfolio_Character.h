...
UCLASS()
class PPGAME_API APortfolio_Character : public APortfolio_GlobalCharacter
{
	GENERATED_BODY()
...
private:
	...
	UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = "PP|Character", Meta = (AllowPrivateAccess = "true"))
