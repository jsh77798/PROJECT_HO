...
UCLASS()
class PPGAME_API APortfolio_GlobalCharacter : public ACharacter
{
	GENERATED_BODY()
...
public:
	...
	virtual bool TakeDamageBone(bool _BoneCheck, FName _BoneName, struct FDamageEvent const& DamageEvent, AController* EventInstigator, AActor* DamageCauser);
	...
	bool GetBoneDamageCheck()
	{
		return BoneCheck;
	}

	void SetBoneDamageCheck(bool _BoneCheck) 
	{
