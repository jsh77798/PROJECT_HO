...
float APortfolio_GlobalCharacter::TakeDamage(float DamageAmount, struct FDamageEvent const& DamageEvent, AController* EventInstigator, AActor* DamageCauser)
{
	//DamageEvent.GetTypeHash();
	Att += DamageAmount;
	HP -= DamageAmount;
...
bool APortfolio_GlobalCharacter::TakeDamageBone(bool _BoneCheck, FName _BoneName, struct FDamageEvent const& DamageEvent, AController* EventInstigator, AActor* DamageCauser)
{
	BoneName = _BoneName;
