...
#include "PPAbilitySystemComponent.generated.h"
...
PPGAME_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_Gameplay_AbilityInputBlocked);
 ...
 */
UCLASS()
class PPGAME_API UPPAbilitySystemComponent : public UAbilitySystemComponent
{
	GENERATED_BODY()

public:

	UPPAbilitySystemComponent(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
	...
	typedef TFunctionRef<bool(const UPPGameplayAbility* PPAbility, FGameplayAbilitySpecHandle Handle)> TShouldCancelAbilityFunc;
...
protected:
	...
	int32 ActivationGroupCounts[(uint8)EPPAbilityActivationGroup::MAX];
