...
#include "PPAbilityTagRelationshipMapping.generated.h"

class UObject;

/** Struct that defines the relationship between different ability tags */
USTRUCT()
struct FPPAbilityTagRelationship
{
	GENERATED_BODY()
...
UCLASS()
class UPPAbilityTagRelationshipMapping : public UDataAsset
{
	GENERATED_BODY()
...
private:
	...
	TArray<FPPAbilityTagRelationship> AbilityTagRelationships;
