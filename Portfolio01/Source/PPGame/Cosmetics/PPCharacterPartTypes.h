...
#include "PPCharacterPartTypes.generated.h"

class UChildActorComponent;
class UPPPawnComponent_CharacterParts;
...
struct FPPCharacterPart
{
	...
	static bool AreEquivalentParts(const FPPCharacterPart& A, const FPPCharacterPart& B)
	{
