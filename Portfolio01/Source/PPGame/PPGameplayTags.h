 ...
 */
struct FPPGameplayTags
{
public:

	static const FPPGameplayTags& Get() { return GameplayTags; }
...
public:
	...
	// Initialization states for the GameFrameworkComponentManager, these are registered in order by PPGameInstance and some actors will skip right to GameplayReady
...
private:
	...
	static FPPGameplayTags GameplayTags;
};
