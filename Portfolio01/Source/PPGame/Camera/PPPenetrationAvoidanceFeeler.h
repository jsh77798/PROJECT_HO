...
#include "PPPenetrationAvoidanceFeeler.generated.h"

/**
 * Struct defining a feeler ray used for camera penetration avoidance.
 */
USTRUCT()
struct FPPPenetrationAvoidanceFeeler
{
	GENERATED_BODY()
	...
	FPPPenetrationAvoidanceFeeler(const FRotator& InAdjustmentRot,
