...
#include "PPPenetrationAvoidanceFeeler.h"
#include "DrawDebugHelpers.h"
#include "PPCameraMode_ThirdPerson.generated.h"

class UCurveVector;

/**
 * UPPCameraMode_ThirdPerson
 *
 *	A basic third person camera mode.
 */
UCLASS(Abstract, Blueprintable)
class UPPCameraMode_ThirdPerson : public UPPCameraMode
{
	GENERATED_BODY()
...
public:
	...
	TArray<FPPPenetrationAvoidanceFeeler> PenetrationAvoidanceFeelers;
