...
#include "AbilitySystem/PPAbilitySourceInterface.h"

#include "PPRangedWeaponInstance.generated.h"

class UPhysicalMaterial;

/**
 * UPPRangedWeaponInstance
 *
 * A piece of equipment representing a ranged weapon spawned and applied to a pawn
 */
UCLASS()
class UPPRangedWeaponInstance : public UPPWeaponInstance, public IPPAbilitySourceInterface
{
	GENERATED_BODY()

public:
	UPPRangedWeaponInstance(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
...
public:
	...
	//~IPPAbilitySourceInterface interface
	...
	//~End of IPPAbilitySourceInterface interface
