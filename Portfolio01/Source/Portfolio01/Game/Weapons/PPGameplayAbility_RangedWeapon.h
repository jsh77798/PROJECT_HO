...
#include "Game/Equipment/PPGameplayAbility_FromEquipment.h"
...
#include "PPGameplayAbility_RangedWeapon.generated.h"

class APawn;
class UPPRangedWeaponInstance;
class UObject;
...
UENUM(BlueprintType)
enum class EPPAbilityTargetingSource : uint8
{
...
/**
 * UPPGameplayAbility_RangedWeapon
 *
 * An ability granted by and associated with a ranged weapon instance
 */
UCLASS()
class UPPGameplayAbility_RangedWeapon : public UPPGameplayAbility_FromEquipment
{
	GENERATED_BODY()

public:

	UPPGameplayAbility_RangedWeapon(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());

	UFUNCTION(BlueprintCallable, Category="Ability")
	UPPRangedWeaponInstance* GetWeaponInstance() const;
...
protected:
	struct FRangedWeaponFiringInput
	{
		...
		UPPRangedWeaponInstance* WeaponData = nullptr;
...
protected:
	...
	FTransform GetTargetingTransform(APawn* SourcePawn, EPPAbilityTargetingSource Source) const;
