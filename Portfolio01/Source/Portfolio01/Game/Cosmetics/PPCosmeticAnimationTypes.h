...
#include "PPCosmeticAnimationTypes.generated.h"
...
struct FPPAnimLayerSelectionEntry
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct FPPAnimLayerSelectionSet
{
	GENERATED_BODY()
	...
	TArray<FPPAnimLayerSelectionEntry> LayerRules;
...
USTRUCT(BlueprintType)
struct FPPAnimBodyStyleSelectionEntry
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct FPPAnimBodyStyleSelectionSet
{
	GENERATED_BODY()
		
	// List of layer rules to apply, first one that matches will be used
	UPROPERTY(EditAnywhere, BlueprintReadWrite, meta=(TitleProperty=Mesh))
	TArray<FPPAnimBodyStyleSelectionEntry> MeshRules;
