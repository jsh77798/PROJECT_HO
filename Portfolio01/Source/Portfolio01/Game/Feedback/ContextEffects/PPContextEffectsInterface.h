...
#include "PPContextEffectsInterface.generated.h"
 ...
 */
 ...
 class PORTFOLIO01_API UPPContextEffectsInterface : public UInterface
 {
	 GENERATED_BODY()

 };
 
 class PORTFOLIO01_API IPPContextEffectsInterface : public IInterface
 {
	 GENERATED_BODY()
