...
struct PORTFOLIO01_API FPPContextEffects
{
	GENERATED_BODY()
 ...
 */
UCLASS()
class PORTFOLIO01_API UPPActiveContextEffects : public UObject
{
	GENERATED_BODY()
...
class PORTFOLIO01_API UPPContextEffectsLibrary : public UObject
{
	GENERATED_BODY()
