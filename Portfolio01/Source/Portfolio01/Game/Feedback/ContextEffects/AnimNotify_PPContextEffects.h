...
#include "AnimNotify_PPContextEffects.generated.h"

/**
 *
 */
USTRUCT(BlueprintType)
struct	PORTFOLIO01_API FPPContextEffectAnimNotifyVFXSettings
{
	GENERATED_BODY()
 ...
 */
USTRUCT(BlueprintType)
struct PORTFOLIO01_API FPPContextEffectAnimNotifyAudioSettings
{
	GENERATED_BODY()
 ...
 */
USTRUCT(BlueprintType)
struct PORTFOLIO01_API FPPContextEffectAnimNotifyTraceSettings
{
	GENERATED_BODY()
 ...
 */
USTRUCT(BlueprintType)
struct PORTFOLIO01_API FPPContextEffectAnimNotifyPreviewSettings
{
	GENERATED_BODY()
	...
	// Preview Library
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = Preview, meta = (AllowedClasses = "/Script/PPGame.PPContextEffectsLibrary"))
...
class PORTFOLIO01_API UAnimNotify_PPContextEffects : public UAnimNotify
{
	GENERATED_BODY()

public:
	UAnimNotify_PPContextEffects();
	...
	// Scale to spawn the particle system at
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "AnimNotify", meta = (ExposeOnSpawn = true))
	FPPContextEffectAnimNotifyVFXSettings VFXProperties;

	// Scale to spawn the particle system at
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "AnimNotify", meta = (ExposeOnSpawn = true))
	FPPContextEffectAnimNotifyAudioSettings AudioProperties;
	...
	FPPContextEffectAnimNotifyTraceSettings TraceProperties;
	...
	FPPContextEffectAnimNotifyPreviewSettings PreviewProperties;
#endif
