...
#include "PPUICameraManagerComponent.generated.h"
...
UCLASS( Transient, Within=PPPlayerCameraManager )
class UPPUICameraManagerComponent : public UActorComponent
{
	GENERATED_BODY()

public:
	static UPPUICameraManagerComponent* GetComponent(APlayerController* PC);

public:
	UPPUICameraManagerComponent();	
