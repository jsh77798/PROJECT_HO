...
#include "PPGameplayCueManager.generated.h"
...
/**
 * UPPGameplayCueManager
 *
 * Game-specific manager for gameplay cues
 */
UCLASS()
class UPPGameplayCueManager : public UGameplayCueManager
{
	GENERATED_BODY()

public:
	UPPGameplayCueManager(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());

	static UPPGameplayCueManager* Get();
